...
exports.GET_ARTICLE_QUERY = exports.GET_ARTICLES_QUERY = exports.GET_DESKS_QUERY = void 0;
exports.GET_DESKS_QUERY = `query {
    desks {
      id
      sid
      name
  ...
  `;
exports.GET_ARTICLES_QUERY = `query (
        $desk: ID
        $published: Boolean
        $unscheduled: Boolean
